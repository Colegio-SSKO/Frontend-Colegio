...
@WebServlet(name = "addpublish", value = "/api/addpublish/*")
@MultipartConfig(
...
public class addpublish extends HttpServlet {
    ...
    public static String handleThumbnail(Part thumbnail, HttpServletRequest request, Integer randomNumber) throws IOException{
        ...
        Integer userID = 1123;
        String thumbnailFilename = "add" + userID + randomNumber +thumbnail.getSubmittedFileName();
        ...
        String saveFilePath = "../../src/main/webapp/static/img/add_img"+thumbnailFilename;
