...
@WebServlet(name = "uploadPropic", value = "/api/uploadPropic/*")
@MultipartConfig(
...
public class uploadPropic extends HttpServlet {
    ...
    public static String handleThumbnail(Part thumbnail, HttpServletRequest request, Integer randomNumber) throws IOException{
        ...
        Integer userID = 1123;
        String thumbnailFilename = "pro" + userID + randomNumber +thumbnail.getSubmittedFileName();
        ...
        String saveFilePath = "../static/img/teachers/"+thumbnailFilename;
