...
public class publishQuestion extends HttpServlet {
    ...
    public static String handleThumbnail(Part thumbnail, HttpServletRequest request, Integer randomNumber) throws IOException{
        ...
        Integer userID = 1123;
        String thumbnailFilename = "ques" + userID + randomNumber +thumbnail.getSubmittedFileName();
