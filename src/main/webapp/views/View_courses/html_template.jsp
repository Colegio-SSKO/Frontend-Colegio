...
<head>
    ...
    <link rel="stylesheet" href="html_template.css">
    <meta charset="UTF-8">
        ...
        <div class="main-right">
            ...
            <div class="cont-body">
                <div class="cont-body-left">
                    <button class="btn btn-solid btn-small">All</button> &nbsp &nbsp
                    <button class="btn btn-outlined btn-small">Continuing</button> &nbsp &nbsp
                    <button class="btn btn-outlined btn-small">Completed</button><br><br>
                ...
                <div class="cont-body-right">
                    <jsp:include page="../../componenets/open_course.jsp"/>
                </div>
            </div>
