...
<q-2 img_src="../static/img/components_images/Rectangle 2310.png" title="Electronics circuits for GCE OLs English Medium" accept="Accepted by Ravin Silva" description="Help with the 2016 OL electronics question through a zoom session."></q-2>