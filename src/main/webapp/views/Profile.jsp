...
<div class="prof">
  <profile-card profile_img="../static/img/components_images/pro.png" name="Senith Uthsara Karunarathne" date="February 2000" gender="Male" education_level="Undergraduate | UCSC"></profile-card>
