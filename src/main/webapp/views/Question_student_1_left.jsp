<div class="btns">
    ...
    <button class="btn btn-solid btn-large btn-shadow fnt fnt-light">Publish <br> Question</button>
    <button class="btn btn-solid btn-large btn-shadow fnt fnt-light">Request <br> Session</button>
</div>
