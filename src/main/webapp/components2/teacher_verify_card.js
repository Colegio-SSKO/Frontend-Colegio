...
class teacher_verifycard extends HTMLElement {
    connectedCallback() {
        ...
        <div class="report-person">
            ...
            <div class="report-person-item-btn">
                    <button class="btn btn-solid btn-large"><a class="genarate_report_person fnt fnt-bold fnt-mid" href="/generate_report_verifyteacher" id="${user_id}">Genarate Report</a></button>
            </div>
        </div>
        `;
...
customElements.define('teacher-verifycard', teacher_verifycard);