class Open_course_video_play extends HTMLElement {
    connectedCallback() {
        ...
        <div class="open-course-iframe">
            <iframe src="./videoplayback.mp4" frameborder="0"></iframe>
        </div>
...
customElements.define('open-course-video-play', Open_course_video_play);