class Report_detailsquiz extends HTMLElement {
    connectedCallback() {
        ...
        this.innerHTML = `<pop-up></pop-up>
            <div class="report-cont-wrap">
                ...
                <div class="report_button">
                    <button class="disable_course btn btn-solid btn-large" id="${data[0].content_id}"> Disable quiz</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
customElements.define('report-listquiz', Report_detailsquiz);
