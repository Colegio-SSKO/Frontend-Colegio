...
<body>
<div class="form">
    <h3>Lets create your Course</h3><br>
    <div class="inputs">
        <div class="input-field">
            <label for="">Select a unique title for your Course.</label><br><br>
            <input type="text" required placeholder="Course Title">
        </div><br><br>

        <div class="input-field">
            <label for="">Select the most appropriate category for your course.</label><br><br>
            <input type="text" required placeholder="Mathematics/ Science/ English...">
        </div><br><br>

        <div class="input-field">
            <label for="">Give your course a good description.</label><br><br>
            <textarea class="description_box" name="description_box" rows="7" cols="40" placeholder="Enter course description here"></textarea>
        </div>

        <div class="input-field">
            <label for="">Course Thumbnail image
        ...
        <div class="input-field">
            <label for="">Course Content Sections <br>
                <p style="color: #767676; margin: 10px 0">Upload your course content here.<br> Important Guideline : All files should be at least 480p and less than 3 GB.</p>
            </label>
        </div>
    </div>
</div>
