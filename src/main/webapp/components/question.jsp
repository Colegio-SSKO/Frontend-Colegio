...
<div class="question-comment-main">
    <div class="comment-about">
        ...
        <div class="Q_description">
            <p class="fnt fnt-bold fnt-mid">Can you help me with understanding basic algebra for grade 9, A step by step answer for the attached question with an explanation.</p>
        </div>
