...
function renderSingle(){
    ...
    fetchData().then(async (data) => {
            ...
            html_left += `<pop-up></pop-up><home-hero><br><br></home-hero><featured-cont img_src = "${"img_src"}" title = "${"title"}" description = "${"description"}" author = "${"author"}" date = "${"date"}" price = "${"price"}" subject = "${"subject"}"></featured-cont> <content-list dataString="${encodeURIComponent(res3)}"></content-list>`;
